...
class OpenlayerElement extends LitElement {
  ...
  constructor() {
    super();
    this.something = "OpenLayer Element"
  }
  ...
  firstUpdated(){
    ...
    //  app.shadowRoot.getElementById('latitude').innerText = app.geolocation.getLatitude();
      //app.shadowRoot.getElementById('longitude').innerText = app.geolocation.getLongitude();
    });
  ...
  customElements.define('openlayer-element', OpenlayerElement);
